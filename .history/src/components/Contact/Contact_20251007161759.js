            ...
            <div className="contact-info-section">
              ...
              <div className="contact-cards">
                <div className="contact-card">
                  ...
                  <span>gouravkrsah78@gmail.com</span>
                </div>
                
                <div className="contact-card">
                  <AiOutlinePhone className="contact-icon" />
                  <span>(+91) 7903840357</span>
                </div>
                
                <div className="contact-card">
                  <AiOutlineLinkedin className="contact-icon" />
                  <span>linkedin.com/in/gourav-java-dev</span>
                </div>
                
                <div className="contact-card">
                  <AiOutlineGithub className="contact-icon" />
                  <span>github.com/Gourav3308</span>
                </div>
              </div>
              ...
              <div className="follow-me-section">
                ...
                <div className="social-icons">
                  <a href="https://linkedin.com/in/gourav-java-dev" target="_blank" rel="noopener noreferrer">
                    <FaLinkedinIn className="social-icon" />
                  </a>
                  <a href="https://github.com/Gourav3308" target="_blank" rel="noopener noreferrer">
                    <FaGithub className="social-icon" />
                  </a>
                  <a href="mailto:gouravkrsah78@gmail.com">
                    <FaEnvelope className="social-icon" />
                  </a>
                  <a href="tel:+917903840357">
